...
const Tooltip = ({ children, side = 'top', size = 'big', dark = true, className, contentClassName }: TooltipProps) => {
	...
	return (
		<div className={cn('relative inline-flex', !dark && 'shadow-drop-neutral-1', className)}>
			{/* 콘텐츠 영역 */}
			<div
				className={cn(
					'rounded-[6px]',
