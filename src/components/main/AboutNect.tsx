...
const AboutNect = () => {
    return (
        <div className="w-282 h-36 mx-auto grid grid-cols-2 gap-6">
            {/* 왼쪽: NECT가 처음이라면? */}
            <div className="relative border-[1.5px] border-primary-300-light rounded-xl p-6 overflow-hidden bg-primary-100-light bg-linear-to-l from-[#660FD8]/4 from-45% to-primary-300 to-100%">
                {/* 배경 원 */}
            ...
            {/* 오른쪽: AI 아이디어 분석 */}
            <div className="relative border-[1.5px] border-[#C1CDF9] rounded-xl p-6 overflow-hidden bg-[#F6F8FF] bg-linear-to-r from-[#889FF5]/4 from-45% to-[#889FF5]/2 to-100%">
                {/* 배경 원 */}
