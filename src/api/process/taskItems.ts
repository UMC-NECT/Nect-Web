import type {
	...
	ResponseTaskItemsDeleteDto,
	ResponseTaskItemsOrderPatchDto,
	ResponseTaskItemsPatchDto,
	ResponseTaskItemsPostDto,
} from '@/types/api/process/taskItems'
import { api } from '@/utils/AxiosInstance'

/** 프로세스(카드)에 업무 항목(TaskItem)을 생성합니다. */
export const postTaskItems = async (
	projectId: string,
	processId: string,
	body: RequestTaskItemsPostDto
): Promise<ResponseTaskItemsPostDto> => {
...
export const patchTaskItemsOrder = async (
	projectId: string,
	processId: string,
...
export const deleteTaskItems = async (
	projectId: string,
	processId: string,
	taskItemId: string
): Promise<ResponseTaskItemsDeleteDto> => {
...
export const patchTaskItems = async (
	projectId: string,
	processId: string,
	taskItemId: string,
	body: RequestTaskItemsPatchDto
): Promise<ResponseTaskItemsPatchDto> => {
